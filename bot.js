...
if (message.content.startsWith('>bcall')){
 if (message.author.id !== '495680518365511721') return message.reply('**:point_up:  هذا الأمر قفط لصاحب البوت و شكراًً :point_up: **')
...
client.on('message', message => {
    ...
    message.channel.send({
        embed: new Discord.RichEmbed()
            ...
            .setColor('RANDOM')
            .setTitle('``INFO FireNetwork`` ')
            .addField('``:hourglass: My Ping``' , [`${Date.now() - message.createdTimestamp}` + 'MS'], true)
...
let welcomer = member.guild.channels.find("name","・welcome");
      ...
      if(welcomer) {
        ...
        .addField('من فضلك اقرأ القوانين',`please read the rules`,true)
...
client.on('message', message => { 
    ...
    .setFooter(`FireNetwork`, 'https://images-ext-2.discordapp.net/external/JpyzxW2wMRG2874gSTdNTpC_q9AHl8x8V4SMmtRtlVk/https/orcid.org/sites/default/files/files/ID_symbol_B-W_128x128.gif')                                 
